...
2. 3 个严格候选的 main vs recent OOS 稳定性已在 `docs/ALPHA360_STRICT_OOS_STABILITY_V1.md` 完成。
3. 19 个 `tradability_exposure_review` 的流动性/可交易性暴露归因已在 `docs/TRADABILITY_EXPOSURE_ATTRIBUTION_V1.md` 完成。
